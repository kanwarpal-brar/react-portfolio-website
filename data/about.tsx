...
export const workExperience: ExpBoxProps[] = [
    {
      ...
      company: "Carta",
      date: "Jan - April 2024",
      paragraph: "Spearheaded several pivotal projects to enhance reporting functionalities within the Carta Web application on Carta's Capitalization and Reporting team. Notable achievements include optimizing the OCX report by integrating voting power information and refining cell relationships for faster Excel formula generation. Additionally, I contributed to the development of an AI-powered search bar, elevating search accuracy through prompt engineering. Collaborated closely with business leaders to revamp report visibility, empowering Portfolio Holders to access critical information seamlessly. I thrived in navigating complex systems, demonstrating adeptness in problem-solving and agile adaptation to evolving project scopes."},
    {
      title: "Software Developer",
      company: "Arctic Wolf Networks",
      date: "May - Aug 2023",
      paragraph: "Worked as a Software Developer Co-op across two vital teams: the Constructicons and the Transporters. Honed skills in Python and Go, crafting core client-facing services and integrating with OpenAPI 3.0 standard RestAPI's. Spearheaded the completion of a crucial internal Apache Kafka service in Go and initiated work on a Python Kafka wrapper. Notably, revamped the metrics monitoring system for the Go Kafka Wrapper, leveraging concurrency techniques to enhance response times. Additionally, designed a forward and backward-compatible Serialization System for Apache Avro schemas, reducing lead times.",
    },
    {
